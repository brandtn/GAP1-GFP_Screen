...
path.save <-"~/Flow_Cytometry_Analysis/IndividualScreen/Reports/"#location to save files
...
ggplot(subset(filter.data, filter.data$WELL==sample.sheet$Well[13:24]), aes(x = FSC.A, y = SSC.A))+
    geom_hex(bins=128)+
    facet_wrap(~ WELL + STRAIN,ncol=6)+
    theme(legend.position="none")+
    scale_x_log10()+
...
ggplot(subset(filter.data, filter.data$WELL==sample.sheet$Well[25:36]), aes(x = FSC.A, y = SSC.A))+
    geom_hex(bins=128)+
    facet_wrap(~ WELL + STRAIN,ncol=6)+
    theme(legend.position="none")+
    scale_x_log10()+
...
ggplot(subset(filter.data, filter.data$WELL==sample.sheet$Well[37:48]), aes(x = FSC.A, y = SSC.A))+
    geom_hex(bins=128)+
    facet_wrap(~ WELL + STRAIN,ncol=6)+
    theme(legend.position="none")+
    scale_x_log10()+
...
ggplot(subset(filter.data, filter.data$WELL==sample.sheet$Well[49:60]), aes(x = FSC.A, y = SSC.A))+
    geom_hex(bins=128)+
    facet_wrap(~ WELL + STRAIN,ncol=6)+
    theme(legend.position="none")+
    scale_x_log10()+
...
ggplot(subset(filter.data, filter.data$WELL==sample.sheet$Well[49:60]), aes(x = FSC.A, y = FL1.A))+
    geom_hex(bins=128)+
    facet_wrap(~ WELL + STRAIN,ncol=6)+
    theme(legend.position="none")+
    scale_x_log10()+
