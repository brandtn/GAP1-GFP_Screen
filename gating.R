...
xyplot(FL1.A~FSC.A,data=flowData[[s]], xlim=c(0,5e6), ylim=c(0,5e4), filter=pg.nongfp, smooth=F, xbin=1024, stat=T, pos=0.5, abs=T)
...
xyplot(FL1.A~FSC.A,data=flowData[[s]], xlim=c(0,5e6), ylim=c(0,5e5), filter=pg.gfp, smooth=F, xbin=1024, stat=T, pos=0.5, abs=T)
...
plot(flowData[[s]], c('FSC.A','FL1.A'), xlim=c(0,3e6), ylim=c(0,2e6), smooth=F)
Egate <- locator(10)
gm.5 <- matrix(,10,2)
...
xyplot(FL1.A~FSC.A,data=flowData[[3]], xlim=c(0,5e6), ylim=c(0,5e4), filter=pg.hi.gfp, smooth=F, xbin=1024, stat=T, pos=0.5, abs=T)
